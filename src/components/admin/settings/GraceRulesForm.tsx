...
export function GraceRulesForm({ initial }: { initial: Grace }) {
  ...
  return (
    <div className="form-grid cols-2">
      ...
      <div className="form-field full"><label className="hstack"><span className={`toggle-v2 ${g.autoRenew24hBeforeExpiry ? 'on' : ''}`} onClick={() => setG({ ...g, autoRenew24hBeforeExpiry: !g.autoRenew24hBeforeExpiry })} /> Auto-renew: charge 24h before expiry <span className="chip muted" style={{ marginLeft: 6, textTransform: 'none', letterSpacing: 'normal' }}>Not wired — Phase 2</span></label></div>
