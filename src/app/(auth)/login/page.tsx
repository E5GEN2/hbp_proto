  ...
  return (
    <div className="panel" style={{ width: 380, padding: 0 }}>
      ...
      <form onSubmit={onSubmit} style={{ padding: '8px 28px 24px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ marginTop: 12, padding: 10, background: 'var(--surface-2)', borderRadius: 8, fontSize: 11.5, color: 'var(--muted)' }}>
          <div><strong style={{ color: 'var(--text)' }}>Demo client:</strong> demo@example.com · demo1234</div>
          <div><strong style={{ color: 'var(--text)' }}>Super admin:</strong> admin@hbp.local · admin1234</div>
        </div>
      </form>
    </div>
  );
